...
<div align="center">
  <p>
    💡 <strong>백엔드</strong> 개발을 중심으로 데이터의 가능성을 탐구하는 학생입니다. <br>
    복잡한 데이터 속에서 <strong>NLP</strong> 기술로 숨은 의미를 찾아내고, 이를 효과적인 <strong>데이터 커뮤니케이션</strong>으로 풀어내는 과정에 큰 매력을 느낍니다. <br>
    최근에는 <strong>프론트엔드</strong> 기술까지 학습하며, 데이터로 가치 있는 경험을 만드는 데이터 사이언티스트를 꿈꾸고 있습니다.
  </p>
</div>
<br>
<div align="center">
